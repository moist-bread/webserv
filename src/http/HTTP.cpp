...
std::string HTTP::stringMethod(const t_method Method) { return (_method_names[Method]); }
...
std::string HTTP::stringProtocol(const t_protocol Protocol) { return (_protocol_names[Protocol]); }
